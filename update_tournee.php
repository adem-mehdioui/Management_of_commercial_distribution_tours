...
<div class="topnav"> 
  ...
  <a id="update" href="#update_tournee" class="nav-item active"><i class="fa fa-edit" aria-hidden="true" >Modifier tournée</i></a>
  <a id="delete" href="#delete_tournee" class="nav-item"><i class="fa fa-trash" aria-hidden="true" >Supprimer tournée</i></a>
